...
class StockBalanceReport:
	...
	def get_columns(self):
		columns = [
			...
			{"label": _("Tên mặt hàng"), "fieldname": "item_name", "width": 250},
			{
				"label": _("Nhóm hàng"),
		...
		columns.extend(
			[
				...
				{
					"label": _("Nhập kho trong kỳ"),
					"fieldname": "in_qty",
					"fieldtype": "Float",
					"width": 180,
					"convertible": "qty",
				},
				{"label": _("Giá trị nhập kho"), "fieldname": "in_val", "fieldtype": "Float", "width": 180},
				{
					"label": _("Xuất kho"),
					"fieldname": "out_qty",
					"fieldtype": "Float",
				...
				{"label": _("Giá trị xuất kho"), "fieldname": "out_val", "fieldtype": "Float", "width": 180},
				{
					"label": _("Giá trị tồn kho"),
					"fieldname": "val_rate",
