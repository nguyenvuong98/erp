...
jenv = {
    "methods": [
        "webshop.webshop.utils.product.get_web_item_qty_in_stock"
    ]
}
...
# Add to existing hooks or create new file
app_include_js = [
    "assets/webshop/js/customer_search.js"
]

# Add custom API methods for customer search
def get_website_context(context):
    context.update({
        "customer_search_enabled": True
    })

# Add to whitelist methods
whitelist = [
    "webshop.api.search_customers",
    "webshop.api.get_customer_details"
]
